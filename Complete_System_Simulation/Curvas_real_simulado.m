...
axf1 = subplot(311);
% plot( Sim.F(1,:),'r','linewidth',2');
plot(Sim.F_out(1,1:end),'b','linewidth',2');hold on; grid on;
...
axf2 = subplot(312);
plot( Sim.F(2,:),'r','linewidth',2');hold on; grid on;
plot( Sim.F_out(2,1:end),'b','linewidth',2');
...
axf3 = subplot(313);
plot( Sim.F(3,:),'r','linewidth',2');hold on; grid on;
plot( Sim.F_out(3,1:end),'b','linewidth',2');
